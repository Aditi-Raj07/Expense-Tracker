        ...
        <form action="" onSubmit={handleSignup}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Inputs
              type="text"
              value={email}
              onChange={({ target }) => setEmail(target.value)} //whenever there is change in the input by the user OnChange event will trigerr
            ...
            <Inputs
              type="text"
              value={fullname}
              onChange={({ target }) => setFullName(target.value)} //whenever there is change in the input by the user OnChange event will trigerr
              //target refers to the DOM element that triggered the event. Specifically, it is a property of the event object that is automatically passed to the event handler function.
            ...
            <div className="col-span-2">
              <Inputs
                type="password"
                value={password}
                onChange={({ target }) => setPassword(target.value)} //whenever there is change in the input by the user OnChange event will trigerr
                //target refers to the DOM element that triggered the event. Specifically, it is a property of the event object that is automatically passed to the event handler function.
                label="Password"
